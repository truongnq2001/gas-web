...
@section('title') Thống kê xuất gas - Quản lý phân phối khí gas @endsection
@section('content')
          <!-- Content wrapper -->
            ...
            <div class="container-xxl flex-grow-1 container-p-y" style="margin-top: 30px;">
                ...
                <div class="col-lg-3 col-md-12 col-6 mb-4">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <span class="fw-semibold d-block mb-1">Số gas xuất trong 30 ngày qua</span>
                      <h3 class="card-title mb-2" style="font-size: 20px;">{{ $exportThirtyDay }} bình</h3>
                    </div>
                  </div>
                </div>
                <div class="col-lg-3 col-md-12 col-6 mb-4">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <span class="fw-semibold d-block mb-1">Số tiền xuất gas trong 30 ngày</span>
                      <h3 class="card-title text-nowrap mb-1" style="font-size: 20px;">{{ $revenueThirtyDay }} VNĐ</h3>
                    </div>
                  </div>
                </div>
                <div class="col-lg-3 mb-4">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <span class="fw-semibold d-block mb-1">Số gas xuất trong năm 2023</span>
                      <h3 class="card-title mb-2" style="font-size: 20px;">{{ $exportYear }} bình</h3>
                    </div>
                  </div>
                </div>
                <div class="col-lg-3 mb-4">
                  <div class="card">
                    <div class="card-body">
                      <div class="card-title d-flex align-items-start justify-content-between">
                        <div class="avatar flex-shrink-0">
                          <span class="badge bg-label-danger p-2"><i class="bx bx-gas-pump text-danger"></i></span>
                        </div>
                        <div class="dropdown">
                        </div>
                      </div>
                      <span class="fw-semibold d-block mb-1">Số tiền xuất gas trong năm 2023</span>
                      <h3 class="card-title text-nowrap mb-2" style="font-size: 20px;">{{ $revenueYear }} VNĐ</h3>
                    </div>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-lg-8 mb-4 order-0">
                  <div class="card">
                    <h5 class="card-header"> Số gas xuất trong năm 2023 (đơn vị tính: bình)</h5>
                    <div class="card-body">
                        <div id="capital"></div>
                    </div>
                  </div>
                ...
                <script>
                    ...
                    behaveLikeLine: true,
                    data: [
                      @foreach ($arrExportMonth as $item)
                ...
                <div class="col-lg-4 col-md-4 order-1">
                  <div class="card">
                    <h5 class="card-header">Số gas xuất theo loại gas năm 2023</h5>
                    <div class="card-body">
                ...
                <script>
                 if ($('#morris_donut').length) {
                    Morris.Donut({
                        ...
                        data: [
                          @foreach ($exportByGas as $item)
                            { value: {{ (int)($item->soluong/$exportYear*100) }}, label: '{{ $item->tenGAS }}' },
                            @endforeach
                        ],
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12" style="margin-bottom: 25px;">
                    <div class="card h-100">
                      <div class="card-title mb-0" style="margin: 25px 0px 0px 25px;">
                          <h5 class="m-0 me-2">Số gas xuất theo khách hàng năm 2023</h5>
                      </div>
                      <div class="card-body">
                          <div id="account" ></div>
                      </div>
                  ...
                  <script>
                    var chart = c3.generate({
                        ...
                        data: {
                            // iris data from R
                            columns: [
                              @foreach ($exportBySupplier as $item)
                                ['{{ $item->tenDL }}', {{ $item->soluong }}],
                                @endforeach 
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 order-0 mb-4">
                    <div class="card h-100">
                        <div class="card-header d-flex align-items-center justify-content-between">
                          <h5 class="card-title m-0 me-2">Số gas xuất nhiều nhất theo khách hàng</h5>
                          <div class="dropdown">
                            <div class="btn-group">
                        ...
                        <div class="card-body" id="exportCustomer">
                          @include('admin.export.topExportCustomer')
                        </div>
                      </div>
                  </div>
                  <script>
                        ...
                        $.ajax({
                            ...
                            success: function(response){
                                if(response.status === "success"){
                                    $('#exportCustomer').html(response.html);
                                }
                            },
                ...
                <div class="row" style="margin-top: 30px;">
                  <div class="card">
                    <div class="cardHeader d-flex align-items-center justify-content-between" style="display: flex;">
                      <h5 class="card-header">Danh sách những lần xuất gas</h5>

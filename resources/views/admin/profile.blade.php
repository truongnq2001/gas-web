                ...
                <div class="card-body">
                  <div class="mb-3 col-12 mb-0">
                    <div class="alert alert-warning">
                      <h6 class="alert-heading fw-bold mb-1">Bạn có chắc chắn muốn xóa tài khoản này?</h6>
                      <p class="mb-0">Nếu bạn xóa tài khoản, bạn sẽ không thể khôi phục lại.</p>
                    </div>
                  </div>
                  <form id="formAccountDeactivation" onsubmit="return false">
                    <div class="form-check mb-3">
                      <input class="form-check-input" type="checkbox" name="accountActivation" id="accountActivation">
                      <label class="form-check-label" for="accountActivation">Tôi đã hiểu và xác nhận xóa tài khoản</label>
                    </div>
